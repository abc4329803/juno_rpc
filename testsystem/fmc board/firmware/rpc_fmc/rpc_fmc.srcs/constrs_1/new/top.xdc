...
set_property PACKAGE_PIN H9 [get_ports TCP_CLK_OUT]
set_property IOSTANDARD LVCMOS25 [get_ports TCP_CLK_OUT]
...
set_property PACKAGE_PIN D10 [get_ports RESET_IN]
