...
// ============================================================================
module UART_BaudGen #(
    parameter CLK_FREQ = 50000000, // 恢复：50MHz 时钟
    parameter BAUD_RATE = 115200,  // 恢复：115200 波特率
...
module UART_Packet_Ctrl (
    ...
    parameter CLK_FREQ = 50000000; // 恢复：50MHz
    parameter BAUD_RATE = 115200;  // 恢复：115200
