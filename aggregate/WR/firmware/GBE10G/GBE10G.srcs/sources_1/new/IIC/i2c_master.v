...
// Description: 
// 
// Dependencies: https://www.circuitden.com/blog/21
// 
// Revision:
...
*/
    ...
    (* mark_debug = "true" *)reg scl_out = 0;
    (* mark_debug = "true" *)reg [ADDR_WIDTH:0] saved_device_addr = 0;
    (* mark_debug = "true" *)reg [REG_WIDTH-1:0] saved_reg_addr = 0;
    //(* mark_debug = "true" *)reg [REG_WIDTH:0] saved_reg_addr = 0;
    (* mark_debug = "true" *)reg [DATA_WIDTH-1:0] saved_mosi_data = 0;
    (* mark_debug = "true" *)reg [7:0] state = S_IDLE;
    (* mark_debug = "true" *)reg [7:0] post_state = S_IDLE;
    (* mark_debug = "true" *)reg [1:0] proc_counter = 0;
    (* mark_debug = "true" *)reg [7:0] bit_counter = 0;
    
    (* mark_debug = "true" *)reg sda_out = 0;
    reg post_sda_out = 0;
    reg ack_recieved = 0;
    (* mark_debug = "true" *)reg enable = 0;
    reg rw = 0;
    
    (* mark_debug = "true" *)wire sda_oe;
    assign sda_oe = (state!=S_IDLE && state!=S_CHECK_ACK && state!=S_READ_REG && state!=S_READ_REG_MSB);
    (* mark_debug = "true" *)wire scl_oe;
