...
xst -ifn xst.scr
move TCP_clk_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\TCP_clk_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc TCP_clk_exdes.ucf TCP_clk_exdes

echo 'Running map'
map -timing -pr b TCP_clk_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm TCP_clk_exdes -w routed.ncd routed.v
cd ..
